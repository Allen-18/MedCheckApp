...
import 'package:practice/screens/simulator.dart';


class ScanResultTile extends StatelessWidget {
   const ScanResultTile({Key? key, required this.result, required Future <void> Function() onTap})
      : super(key: key);
 ...
 Future<VoidCallback?> onTap() async {
     if (result.advertisementData.connectable) {
       try {
         ...
         BluetoothCharacteristic? jsonCharacteristic;
         ...
         if (jsonCharacteristic != null) {
           await jsonCharacteristic.setNotifyValue(true);
           jsonCharacteristic.value.listen((value) {
             String receivedStr = utf8.decode(value);
         ...
         if (kDebugMode) {
           print('Eroare la conectare sau citire: $e');
         }
       }
     }
     return null;
